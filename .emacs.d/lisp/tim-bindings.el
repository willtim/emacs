...
;;
;; many ideas taken from the Emacs Starter Kit.
...
;; C-x TAB is ido-menu
(global-set-key (kbd "C-x TAB") 'ido-menu)

;; indent-rigidly
(global-set-key (kbd "C-x C-.") 'indent-rigidly)

;; kill-ring browse window
...
;; Start a regular shell (zsh for me)
